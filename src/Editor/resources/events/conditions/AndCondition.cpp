...
bool editor::resources::events::AndCondition::render() {
    ImGui::BeginChild((std::string("##andCondition") + std::to_string(reinterpret_cast<long long>(this))).c_str(), ImVec2(0, 0), true);
...
bool editor::resources::events::AndCondition::writeParamsToEngine(sol::table& params) {
