\chapter{Motor de \baker}
\label{cap:motor}

\chapterquote{Quiero crear una colección de juegos a lo largo de mi carrera, para que cuando esté en mi lecho de muerte pueda mirar atrás y ver que creé todas estas cosas maravillosas que le dieron alegría a la gente.}{Eric Barone}
	...
	\centering
		\begin{tikzpicture}[every node/.style={font=\small}]
			...
			\end{class}
  			...
  			\begin{class}[text width=6cm]{ResourceMemoryManager}{7,-5}
...
\figura{Vectorial/audiomixers}{width=\textwidth}{fig:audiomixers}{Representación de un ejemplo de las conexiones de los elementos del sistema de audio del motor.}
...
\begin{figure}[t]
	\centering
		...
		\end{tikzpicture}
		\caption{Esquema de la estructura de un evento del motor.} 
		\label{fig:eventosmotor}
\end{figure}
