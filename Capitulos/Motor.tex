...
\figura{Vectorial/esquema\_ec}{width=0.7\textwidth}{fig:esquema\_ec}{Esquema de la estructura del sistema de entidad componente del motor.}
...
\figura{Vectorial/esquema\_recursos}{width=0.7\textwidth}{fig:esquema\_recursos}{Esquema de la estructura del sistema de gestión de recursos del motor.}
...
\figura{Vectorial/esquema\_audiomixers}{width=0.7\textwidth}{fig:esquema\_audiomixers}{Representación de un ejemplo de las conexiones de los elementos del sistema de audio del motor.}
...
\figura{Vectorial/esquema\_eventos\_motor}{width=0.7\textwidth}{fig:esquema\_eventos\_motor}{Esquema de la estructura de un evento del motor.}
