...
\figuratikz{Diagrama que muestra la separación entre motor y \textit{gameplay} que suelen tener motores más generales.}{fig:separaciongeneral}{
...
\figuratikz{Diagrama que muestra la separación entre motor y \textit{gameplay} que suelen tener motores específicos.}{fig:separacionespecificos}{
\draw (0,0) rectangle (3,6);
\draw (0,4) -- (3,4);
