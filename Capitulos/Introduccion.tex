	...
	\scalebox{0.9}{
		\begin{ganttchart}[
    		...
    		x unit=0.65cm
  			...
  			\gantttitle[title/.style={fill=blue!15, draw=black, line width=0.4pt}]{Dic.}{2}
  			\gantttitle[title/.style={fill=green!15, draw=black, line width=0.4pt}]{En.}{2}
  			...
  			\gantttitle[title/.style={fill=green!15, draw=black, line width=0.4pt}]{Abr.}{2}
  			\gantttitle[title/.style={fill=green!15, draw=black, line width=0.4pt}]{May.}{2}\\
  						
			\ganttbar{Investigación del estado actual}{1}{9}\\	
			\ganttbar{Diseño de \baker}{1}{9}\\
			\ganttbar{Desarrollo del motor}{9}{16}\\
			\ganttbar{Desarrollo del editor}{9}{16}\\
			\ganttbar{Desarrollo de la memoria}{11}{16}\\
			\ganttbar{Pruebas con usuarios}{13}{15}
		\end{ganttchart}
	}
