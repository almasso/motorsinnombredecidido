	...
	\scalebox{0.9}{
		\begin{ganttchart}[
			...
			\gantttitle[title/.style={fill=blue!15}]{Oct.}{1}
  			...
  			\gantttitle[title/.style={fill=blue!15}]{Dec.}{1}
  			\gantttitle[title/.style={fill=green!15}]{Jan.}{1}
  			\gantttitle[title/.style={fill=green!15}]{Feb.}{1}
  			\gantttitle[title/.style={fill=green!15}]{Mar.}{1}
  			\gantttitle[title/.style={fill=green!15}]{Apr.}{1}
  			\gantttitle[title/.style={fill=green!15}]{May}{1}\\
	
			\ganttbar{Research on the current state}{2024-10}{2025-02}\\
			\ganttbar{\baker{} design}{2024-10}{2025-02}\\
