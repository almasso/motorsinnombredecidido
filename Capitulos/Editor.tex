\chapter{Editor de \baker}
\label{cap:editor}

\chapterquote{Una interfaz de usuario debería ser tan sencilla que hasta un novato en una emergencia pueda entenderla en diez segundos.}{Ted Nelson}


\begin{resumen}
En este capítulo se explicará, de manera resumida, la implementación del editor de \baker{} junto con algunos sistemas que lo componen.
\end{resumen}
