...
\figura{Bitmap/welcomewindow}{width=0.7\textwidth}{fig:welcomewindow}{Ventana de bienvenida de \textit{RPGBaker}.}
\figura{Bitmap/eventos}{width=0.7\textwidth}{fig:eventwindow}{Ventana de edición de eventos de \textit{RPGBaker}.}
\figura{Bitmap/conexiones}{width=0.7\textwidth}{fig:conexiones}{Ventana conexiones entre mapas de \textit{RPGBaker}.}
\figura{Bitmap/jugador}{width=0.7\textwidth}{fig:playerwindow}{Ventana de edición del jugador de \textit{RPGBaker}.}
\figura{Bitmap/animwizard}{width=0.7\textwidth}{fig:animwizard}{Asistente para la creación de animaciones de \textit{RPGBaker}.}
